...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed top-0 z-50 bg-red-800 p-2 grid grid-cols-navbarCols grid-rows-1 grid-flow-col items-center gap-x-2 text-white">
      <div className="flex items-center md:pl-6">
        <Link href="/">
          <Image src={pizzaLogo} alt="pizza logo" className="w-14 md:w-20  " />
        </Link>
      ...
      <div className="flex  justify-between md:justify-self-end text-3xl md:pr-6 ">
